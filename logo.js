...
const GROUPS = [
  /* [v4.8] HS효성(487570)은 2024년 효성그룹에서 계열분리된 신설 지주라 자체 CI 이미지가
     아직 로고 소스들에 없다. 같은 그룹의 HS효성첨단소재(298050) CI 로 대체한다.
     이름이 'HS효성'으로 시작하는 계열 전부에 적용되며, '효성'(004800·조현준측)과는
     다른 그룹이므로 반드시 '효성' 항목보다 먼저 와야 한다(긴 접두어 우선 규칙). */
  ['HS효성', '298050', '#2e2a72'],
